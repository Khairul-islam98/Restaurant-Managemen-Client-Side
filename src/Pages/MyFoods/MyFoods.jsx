...
const MyFoods = () => {
    ...
    useEffect(() => {
        axios.get(`https://restaurant-management-server-snowy.vercel.app/products?email=${user.email}`)
            .then((response) => {
    ...
    const handleUpdate = e => {
        ...
        axios.put(`https://restaurant-management-server-snowy.vercel.app/products/${selectedFoodItem._id}`, foodUpdate)
            .then((res) => {
