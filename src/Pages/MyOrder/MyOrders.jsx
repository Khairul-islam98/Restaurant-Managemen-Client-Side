...
const MyOrders = () => {
    ...
    useEffect(() => {
        axios.get(`https://restaurant-management-server-sigma.vercel.app/orders?buyerEmail=${user.email}`)
            .then((response) => {
    ...
    const handleDelete = (_id) => {
        axios.delete(`https://restaurant-management-server-sigma.vercel.app/orders/${_id}`)
            .then(data => {
