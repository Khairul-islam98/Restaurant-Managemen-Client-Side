...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y bg-[#0e7490] text-white">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">Restaurant <br /> Management</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    <a rel="noopener noreferrer" href="#">More Search</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#">Testimonial</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#">Event</a>
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-3">
                            <h3 className="tracki uppercase dark:text-gray-50">Our Menu</h3>
                            <ul className="space-y-1">
                                <li>
                                    <a rel="noopener noreferrer" href="#">Lunch</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#">Dinner</a>
                                </li>
                                <li>
